...
def test_simple_get_leaf_tensors() -> None:
...
def test_get_leaf_tensors_excluded_1() -> None:
    """
...
def test_get_leaf_tensors_excluded_2() -> None:
    """
    Tests that _get_leaf_tensors works correctly when some tensors are excluded from the search.
...
def test_get_leaf_tensors_leaf_not_requiring_grad() -> None:
    """
...
def test_get_leaf_tensors_model() -> None:
    """
...
def test_get_leaf_tensors_model_excluded_2() -> None:
    """
    Tests that _get_leaf_tensors works correctly when the autograd graph is generated by a simple
...
def test_get_leaf_tensors_single_root() -> None:
...
def test_get_leaf_tensors_empty_roots() -> None:
    """Tests that _get_leaf_tensors returns no leaves when roots is the empty set."""
...
def test_get_leaf_tensors_excluded_root() -> None:
...
def test_get_leaf_tensors_deep(depth: int) -> None:
...
def test_get_leaf_tensors_leaf() -> None:
...
def test_get_leaf_tensors_tensor_not_requiring_grad() -> None:
    """
...
def test_get_leaf_tensors_excluded_leaf() -> None:
...
def test_get_leaf_tensors_excluded_not_requiring_grad() -> None:
    """
